...
<body>
   ...
   <%@ page import = "java.sql.Connection" %>
	...
	%>
        ...
        <td><a href="ViewTeacherAchievement2.jsp?username=<%=rs1.getString("username")%>&year=<%=rs1.getString("year")%>&branch=<%=rs1.getString("branch")%>"><button type="button">View Details</button></a></td>
        </tr>
        <%
            }
        }
        ...
        %>
         ...
         <br/><br/><a href="ViewTeacherAchievement.jsp"><button type="button">Back</button></a>
        </center> 
